###########################################
# Mistral model example with llama_cpp_python
###########################################
# libraries
...
# model
model_path ="/kellogg/software/llama_cpp/models/mistral-7b-v0.1.Q5_K_S.gguf"
...
# Prompts
prompt = "Please randomly select an ice cream flavor. Here is an example: rocky road."
